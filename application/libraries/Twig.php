...
require_once APPPATH . 'third_party/Twig-1.35.2/lib/Twig/Autoloader.php';
...
class Twig
{
	...
	private $functions_safe = [
		...
		'set_radio', 'set_select', 'set_checkbox','validation_errors'
	];
	...
	public function render($view, $params = [])
	{
		...
		/* Ajouter mes filtres */
		$filter = new \Twig_SimpleFilter('base64' , function($string){
			//var_dump($str); die;
			return base64_encode($string);
		});
		$this->twig->addFilter($filter);

		/* ajouter un support pour les sessions */
